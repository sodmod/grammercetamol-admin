...
function DesktopSidebar(prop){
  ...
  return <>
    <Col xs={12} sm={prop.showFullSideBar ? 3 : 2}
         className={`${prop.showFullSideBar ? "sidebar" : "p-0"} d-none d-sm-block bg-dark`}>
      <Navbar className="mx-auto w-100 flex-column">
        <Navbar.Brand onClick={() => redirect("/dashboard")} className="fw-bold fs-2">
          {<img src={Logo} alt=""/>}
